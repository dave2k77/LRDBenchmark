...
latex_documents = [
    (master_doc, 'LRDBench.tex', 'LRDBench Documentation',
     'LRDBench Development Team', 'manual'),
]
...
texinfo_documents = [
    (master_doc, 'LRDBench', 'LRDBench Documentation',
     author, 'LRDBench', 'Long-Range Dependence Benchmarking Framework',
     'Miscellaneous'),
]
