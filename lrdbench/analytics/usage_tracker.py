...
class UsageTracker:
    ...
    def track_estimator_usage(self, 
                             estimator_name: str,
                             parameters: Dict[str, Any],
                             execution_time: float,
                             success: bool,
    ...
    def get_usage_summary(self, days: int = 30) -> UsageSummary:
        ...
        for event in recent_events:
            # Estimator usage
            estimator_usage[event.estimator_name] = estimator_usage.get(event.estimator_name, 0) + 1
            ...
            for key, value in event.parameters.items():
                ...
                str_value = str(value)
                parameter_frequency[key][str_value] = parameter_frequency[key].get(str_value, 0) + 1
